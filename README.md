...
* ~~"[Review of exercise submissions](https://youtu.be/UunbNeXhhaU?t=125)"~~
* "[Animated hover transitions wih SVG and CSS](https://youtu.be/UunbNeXhhaU?t=175)"
* "[Removing default margins and scrollbar with CSS](https://youtu.be/UunbNeXhhaU?t=383)" ...`<style>body {margin: 0; overflow: hidden;}</style>`
* "[Review of more submissions](https://youtu.be/UunbNeXhhaU?t=482)"